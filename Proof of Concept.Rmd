...
This graph is a lot harder to parse.  The visNetwork actually causes my computer to crash - not great.  I think it might be intersting to play around with though, if it can work well in the shiny app.  VisNetwork's default layout is pretty good, as the typically reliable Fruchterman-Reingold layout is really distorted by the unconnected node.
